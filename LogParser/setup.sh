...
aws logs create-log-group --log-group-name '/lambda-sharp/log-parser/juant-dev' --profile lambdasharp
...
aws s3api create-bucket --bucket $1"lambda-sharp-s3-logs" --create-bucket-configuration LocationConstraint=$2
